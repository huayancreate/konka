...
- (id)init
{
    if ((self = [super init]))
    {
		...
		[cacheInQueue setMaxConcurrentOperationCount:NSOperationQueueDefaultMaxConcurrentOperationCount];
        cacheOutQueue = [[NSOperationQueue alloc] init];
		[cacheOutQueue setMaxConcurrentOperationCount:NSOperationQueueDefaultMaxConcurrentOperationCount];
