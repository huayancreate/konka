...
- (void)viewDidLoad
{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@%@?method=loginOnGet&__username=%@&__password=%@&__return_url=%@", BaseVipURL, LoginOnGetApi,[self encodeURL:self.userLogin.user_name],self.userLogin.password,[self encodeURL:@"http://vip.konka.com/customer/manager/JxcKonkaOrderRegister.do?method=listpdselect"]];
