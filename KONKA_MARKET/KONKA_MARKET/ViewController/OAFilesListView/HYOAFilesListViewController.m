...
- (void)viewDidLoad
{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@%@?method=list3&username=%@&userpass=%@&user_id=%d", BaseURL, OASearchApi,[self encodeURL:self.userLogin.user_name],self.userLogin.password,[self.userLogin.user_id intValue] ];
